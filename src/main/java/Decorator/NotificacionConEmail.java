...
public class NotificacionConEmail extends NotificacionDecorator {
    ...
    /**
     * Ejecuta la notificación original y agrega el envío de Email.
     */
    @Override
    public void enviar(String mensaje) {

        // Ejecutamos la notificación anterior
        notificacion.enviar(mensaje);

        // Agregamos la nueva funcionalidad
        System.out.println(
